...
"""
    model = get_resnest(name)
    'resnest50', 'resnest101', 'resnest200', 'resnest269'
    Example:
    model = get_resnest("resnest50")
"""
...
class get_resnest(nn.Module):
    def __init__(self, name, pretrained=True):
        super(get_resnest, self).__init__()

        if name not in ["resnest50", "resnest101", "resnest200", "resnest269"]:
...
if __name__ == "__main__":
    model = get_resnest("resnest50", False)
    # model = resnest50()
    # print(model)
